...
export function renderOrderSummary(){
    ...
    cart.forEach((cartItem)=>{
        const matchingCart = getProduct(cartItem.productId);
        ...
        cartSummaryHTML += `
            <div class="cart-item-container js-cart-item-container-${matchingCart.id}">
                ...
                <div class="cart-item-details">
                    ...
                    $${formatCurrency(matchingCart.priceCents)}
                    </div>
                ...
                <div class="delivery-options">
                    ...
                    ${deliveryOptionsHTML(matchingCart, cartItem)}
                </div>
                </div>
            </div>
        `
    })
    function deliveryOptionsHTML(matchingCart, cartItem){
        let html = '';
        deliveryOptions.forEach((deliveryOption) =>{
            ...
            html += `
                <div class="delivery-option js-delivery-option"
                    ...
                    name="delivery-option-${matchingCart.id}">
                    <div>
    ...
    document.querySelectorAll('.js-delete-link').forEach((deleteElement)=>{
        deleteElement.addEventListener('click', ()=>{
            let productId = deleteElement.dataset.productId;
    ...
    document.querySelectorAll('.js-delivery-option').forEach((element)=>{
        element.addEventListener('click', ()=>{
            ...
            updateDeliveryOption(prodId, deliveryId);
            renderOrderSummary();
        });
    });
}